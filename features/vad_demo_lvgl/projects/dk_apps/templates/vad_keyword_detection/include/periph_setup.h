...
#define ENABLE_MIC
#define VAD_PERIPH
#define ENABLE_DSPOTTER_LIB
#define USE_LEDS
#define nSUPPORT_UART_DUMP_RECORD
#define USE_MARKER_PIN

#ifdef dg_configLCD_GUI
#undef USE_LEDS                 // If LDC used LEDs should be disabled, build OQSPI without LCD support
#endif

#define nMEASURE_NFI            // Monitor VAD only, LIB should be disabled.
#ifdef MEASURE_NFI
#undef ENABLE_DSPOTTER_LIB
#endif

#ifdef dg_configLCD_GUI
#define UI_CHANGE_IMG_EVT       (1 << 3)
#define UI_CHANGE_TEXT_EVT      (1 << 4)
#endif
#define BUTTON_NOTIF            (1 << 5)
#define AUDIO_DATA_NOTIF        (1 << 6)
#define UART_FINISHED_NOTIF     (1 << 7)
#define BUTT_EVT_NOTIF_MASK     (1 << 8)
#define AUDIO_START_NOTIF       (1 << 9)
#define AUDIO_STOP_NOTIF        (1 << 10)
#define AUDIO_DATA_LOST_NOTIF   (1 << 11)
#define VAD_EVT_NOTIF_MASK      (1 << 12)
#define LED_TIMEOUT_NOTIF       (1 << 13)
#define NFI_TIMEOUT_NOTIF       (1 << 14)
#define LCD_TIMEOUT_NOTIF       (1 << 15)

#ifdef USE_MARKER_PIN
//#define MARKER_PIN0     HW_GPIO_PORT_0, HW_GPIO_PIN_14  // Used as CMAC_DIAG_0 xxx
//#define MARKER_PIN1     HW_GPIO_PORT_0, HW_GPIO_PIN_15  // Used as CMAC_DIAG_2 xxx
//#define MARKER_PIN2     HW_GPIO_PORT_0, HW_GPIO_PIN_16  // Used as CMAC_DIAG_3 xxx
#define MARKER_PIN0     HW_GPIO_PORT_1, HW_GPIO_PIN_8 // P1_08 eMMC_D3
#define MARKER_PIN1     HW_GPIO_PORT_0, HW_GPIO_PIN_25 // P1_02 eMMC_D0
#define MARKER_PIN2     HW_GPIO_PORT_1, HW_GPIO_PIN_10 // P1_10 eMMC_D1
#endif

#define BUTTON_PIN      HW_GPIO_PORT_1, HW_GPIO_PIN_22  // Button K1
#define MIC_PWR_PIN     HW_GPIO_PORT_0, HW_GPIO_PIN_21


//#define AUDIO_UART_TX_PIN       HW_GPIO_PORT_0, HW_GPIO_PIN_9
#define AUDIO_UART_TX_PIN       HW_GPIO_PORT_0, HW_GPIO_PIN_8
#define AUDIO_UART              HW_UART1
#define AUDIO_UART_PIN_FUNC     HW_GPIO_FUNC_UART_TX
