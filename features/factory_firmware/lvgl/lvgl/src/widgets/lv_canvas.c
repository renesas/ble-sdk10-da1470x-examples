...
#if (DLG_LVGL_CF == 1)
    canvas->dsc.header.cf = cf & ~LV_IMG_CF_RLE_FLAG;
    canvas->dsc.header.rle = !!(cf & LV_IMG_CF_RLE_FLAG);
#else
...
#if (DLG_LVGL_CF == 1)
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_rect: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
                         ...
                         lv_draw_label_dsc_t * draw_dsc, const char * txt)
{
    ...
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_text: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
                        ...
                        const lv_draw_img_dsc_t * draw_dsc)
{
    ...
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_img: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
                         ...
                         const lv_draw_line_dsc_t * draw_dsc)
{
    ...
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_line: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
                            ...
                            const lv_draw_rect_dsc_t * draw_dsc)
{
    ...
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_polygon: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
                        ...
                        int32_t end_angle, const lv_draw_arc_dsc_t * draw_dsc)
{
    ...
    if (!!(dsc->header.cf & LV_IMG_CF_RLE_FLAG))
    {
        LV_LOG_WARN("lv_canvas_draw_arc: can't draw to RLE canvas");
        return;
    }
#endif /* DLG_LVGL_CF */
