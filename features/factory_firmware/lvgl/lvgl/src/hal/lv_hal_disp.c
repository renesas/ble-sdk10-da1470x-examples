...
#if (DLG_LVGL_CF == 1)
static void set_px_cb_argb8888(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_argb4444(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_argb1555(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_rgba8888(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_rgba4444(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_rgba5551(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_rgb888(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_rgb565(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);
#endif /* DLG_LVGL_CF */
...
void lv_disp_drv_use_generic_set_px_cb(lv_disp_drv_t * disp_drv, lv_img_cf_t cf)
{
    switch(cf) {
        ...
        case LV_IMG_CF_ARGB8888:
            disp_drv->set_px_cb = set_px_cb_argb8888;
            break;
        case LV_IMG_CF_ARGB4444:
            disp_drv->set_px_cb = set_px_cb_argb4444;
            break;
        case LV_IMG_CF_ARGB1555:
            disp_drv->set_px_cb = set_px_cb_argb1555;
            break;
        case LV_IMG_CF_RGBA8888:
            disp_drv->set_px_cb = set_px_cb_rgba8888;
            break;
        case LV_IMG_CF_RGBA4444:
            disp_drv->set_px_cb = set_px_cb_rgba4444;
            break;
        case LV_IMG_CF_RGBA5551:
            disp_drv->set_px_cb = set_px_cb_rgba5551;
            break;
        case LV_IMG_CF_RGB888:
            disp_drv->set_px_cb = set_px_cb_rgb888;
            break;
        case LV_IMG_CF_RGB565:
            disp_drv->set_px_cb = set_px_cb_rgb565;
            break;
#endif /* DLG_LVGL_CF */
        default:
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_ARGB8888;
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_ARGB4444;
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_ARGB1555;
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_RGBA8888;
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_RGBA4444;
                                ...
                                lv_color_t color, lv_opa_t opa)
{
    ...
    d.header.h = 1;    /*Doesn't matter*/;
    d.header.w = buf_w;
    d.header.cf = LV_IMG_CF_RGBA5551;
