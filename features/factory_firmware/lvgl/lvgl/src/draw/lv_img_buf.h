...
#if (DLG_LVGL_CF == 1)
#define LV_IMG_BUF_SIZE_RGB565(w, h)   (w * h * 2)
#define LV_IMG_BUF_SIZE_RGB888(w, h)   (w * h * 4)
#define LV_IMG_BUF_SIZE_ARGB8888(w, h) (w * h * 4)
#define LV_IMG_BUF_SIZE_RGBA8888(w, h) (w * h * 4)
#define LV_IMG_BUF_SIZE_RGBA4444(w, h) (w * h * 2)
#define LV_IMG_BUF_SIZE_ARGB4444(w, h) (w * h * 2)
#define LV_IMG_BUF_SIZE_ARGB1555(w, h) (w * h * 2)
#define LV_IMG_BUF_SIZE_RGBA5551(w, h) (w * h * 2)
#define LV_IMG_BUF_SIZE_AI44(w, h) ((w * h) + 4 * 16)
#endif /* DLG_LVGL_CF */
...
typedef struct {
    ...
    uint32_t rle : 1; /*RLE encoded image*/
#else
