...
#ifndef E1394AA65A_DSPI_H_
#define E1394AA65A_DSPI_H_
...
#endif
#define GDI_LCDC_CONFIG          (&e1394aa65a_dspi_cfg)
#define GDI_USE_CONTINUOUS_MODE  (0)

/*
 * static const ad_io_conf_t e1394aa65a_dspi_gpio_cfg[] = {
 *       { E1394AA65A_DSPI_SCK_PORT, E1394AA65A_DSPI_SCK_PIN, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_LCD_SPI_CLK, true }, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO, true }},
 *       { E1394AA65A_DSPI_DO_PORT,  E1394AA65A_DSPI_DO_PIN,  { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_LCD_SPI_DO,  true }, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO, true }},
 *       { E1394AA65A_DSPI_DC_PORT,  E1394AA65A_DSPI_DC_PIN,  { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_LCD_SPI_DC,  true }, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO, true }},
 *       { E1394AA65A_DSPI_CS_PORT,  E1394AA65A_DSPI_CS_PIN,  { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_LCD_SPI_EN,  true }, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO, true }},
 *       { E1394AA65A_DSPI_RST_PORT, E1394AA65A_DSPI_RST_PIN, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO,        true }, { HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO, true }},
 *       { E1394AA65A_DSPI_TE_PORT,  E1394AA65A_DSPI_TE_PIN,  { HW_GPIO_MODE_INPUT,  HW_GPIO_FUNC_LCD,         true }, { HW_GPIO_MODE_INPUT,  HW_GPIO_FUNC_GPIO, true }},
 * };
...
static GDI_DRV_CONF_ATTR ad_lcdc_driver_conf_t e1394aa65a_dspi_drv = {
        ...
        .hw_init.iface_conf.dspi.spi3 = false,
        .ext_clk = HW_LCDC_EXT_CLK_OFF,
        .te_enable = false,
        .te_mode = HW_LCDC_TE_POL_HIGH,
};

static const ad_lcdc_controller_conf_t e1394aa65a_dspi_cfg = {
        .io = &e1394aa65a_dspi_io,
        .drv = &e1394aa65a_dspi_drv,
};

typedef enum {
        E1394AA65A_DSPI_PIXEL_FORMAT_RGB111 = 0x3,
        E1394AA65A_DSPI_PIXEL_FORMAT_L8     = 0x1,
        E1394AA65A_DSPI_PIXEL_FORMAT_RGB332 = 0x2,
        E1394AA65A_DSPI_PIXEL_FORMAT_RGB565 = 0x5,
        E1394AA65A_DSPI_PIXEL_FORMAT_RGB666 = 0x6,
        E1394AA65A_DSPI_PIXEL_FORMAT_RGB888 = 0x7,
} E1394AA65A_DSPI_PIXEL_FORMAT;
...
__STATIC_INLINE bool screen_set_color_mode(HW_LCDC_OUTPUT_COLOR_MODE color_mode)
{
        ...
        case HW_LCDC_OCM_8RGB565:
                value = E1394AA65A_DSPI_PIXEL_FORMAT_RGB565;
                break;
        case HW_LCDC_OCM_8RGB666:
                value = E1394AA65A_DSPI_PIXEL_FORMAT_RGB666;
                break;
        case HW_LCDC_OCM_8RGB888:
                value = E1394AA65A_DSPI_PIXEL_FORMAT_RGB888;
                break;
        default:
...
static const uint8_t screen_init_cmds[] = {
        ...
        LCDC_MIPI_SET_MODE(GDI_DISP_COLOR == HW_LCDC_OCM_8RGB565 ? E1394AA65A_DSPI_PIXEL_FORMAT_RGB565 :
                           GDI_DISP_COLOR == HW_LCDC_OCM_8RGB666 ? E1394AA65A_DSPI_PIXEL_FORMAT_RGB666 :
                                                                   E1394AA65A_DSPI_PIXEL_FORMAT_RGB888),
