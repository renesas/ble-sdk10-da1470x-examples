...
static GDI_DRV_CONF_ATTR ad_lcdc_driver_conf_t t1d3bp006_drv = {
        .hw_init.phy_type = T1D3BP006_SPI3 ? HW_LCDC_PHY_MIPI_SPI3 : HW_LCDC_PHY_MIPI_SPI4,
...
typedef enum {
        T1D3BP006_PIXEL_FORMAT_RGB444 = 0x03,
        T1D3BP006_PIXEL_FORMAT_RGB565 = 0x05,
        T1D3BP006_PIXEL_FORMAT_RGB666 = 0x06,
} T1D3BP006_PIXEL_FORMAT;
...
__STATIC_INLINE bool screen_set_color_mode(HW_LCDC_OUTPUT_COLOR_MODE color_mode)
{
        ...
        case HW_LCDC_OCM_8RGB444:
                value = T1D3BP006_PIXEL_FORMAT_RGB444;
                break;
        case HW_LCDC_OCM_8RGB565:
                value = T1D3BP006_PIXEL_FORMAT_RGB565;
                break;
        case HW_LCDC_OCM_8RGB666:
                value = T1D3BP006_PIXEL_FORMAT_RGB666;
                break;
        default:
...
static const uint8_t screen_init_cmds[] = {
        ...
        LCDC_MIPI_SET_MODE(GDI_DISP_COLOR == HW_LCDC_OCM_8RGB444 ? T1D3BP006_PIXEL_FORMAT_RGB444 :
