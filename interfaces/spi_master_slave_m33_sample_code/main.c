 ...
 * @file main.c
 *
 * @brief SPI adapter demonstration example for SYSCPU
 *
...
static OS_TASK_FUNCTION(system_init, pvParameters)
{
        ...
        status = OS_TASK_CREATE("SPI M/S",             /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                        spi_master_slave_task,          /* The function that implements the task. */
